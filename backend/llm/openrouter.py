...
class OpenRouterClient:
    ...
    def sanitize_messages(self, messages: list[dict]) -> list[dict]:
        """Basic message sanitization to prevent HTML/script injection"""
        sanitized = []
        for msg in messages:
            content = msg.get('content', '')
            # Basic HTML stripping - expand with additional security checks
    ...
    async def chat(
        ...
        "synthetic": True,
        "watermark": "AI-Generated:PolicyProbe-v1.0"
    }
    ...
    async def chat_with_context(
        ...
        """
        messages = [{"role": "system", "content": f"I am an AI assistant. {system_prompt}"}]
    ...
    async def analyze_document(self, content: str) -> str:
        ...
        return await self.chat_with_context(
            ...
            system_prompt="I am an AI assistant. You are a document analyst. Analyze the provided content and summarize key points.",
            context=content
        )
